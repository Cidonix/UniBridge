...
{
    /// <summary>
    /// Main API for controlling the UniBridge MCP Bridge lifecycle and querying connection status.
    ...
    public static class UnityMCPBridge
    {
        ...
        {
            // Forward the public MaxDirectConnections API onto the census's
        ...
        // ──────────────────────────────────────────────
        //  MaxDirectConnections policy facade
        // ──────────────────────────────────────────────
        //
        ...
        /// <summary>
        /// Resolver for the maximum number of concurrent local MCP connections.
        ...
        public static Func<int> MaxDirectConnectionsResolver
        {
            ...
            set
            {
                ...
                ConnectionCensus.SetPolicy(new ConnectionPolicy(next));
            }
        }
        ...
        /// <summary>
        /// Restores the default local direct-connection cap.
        ...
        {
            // Re-applying local settings restores the full policy. If the
            // policy actually changes, the census fires PolicyChanged which
            // our Init() forwarder translates to MaxDirectConnectionsPolicyChanged;
            // if it's already at default, SetPolicy is a no-op, so we fire explicitly.
            var before = ConnectionCensus.Policy;
            Connection.LocalConnectionPolicyWiring.Apply();
