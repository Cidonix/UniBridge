...
namespace Cidonix.UniBridge.MCP.Editor.Settings.Integration
{
    ...
    /// Handles adding and removing UniBridge MCP server configuration from Claude Code's config files.
    /// </summary>
    class ClaudeCodeIntegration : IClientIntegration
    {
        ...
        /// <summary>
        /// Configures the Claude Code client by adding UniBridge MCP server to its project-specific configuration.
        /// </summary>
        ...
        /// <summary>
        /// Disables the Claude Code integration by removing UniBridge MCP server from its configuration.
        /// </summary>
        ...
        /// <summary>
        /// Checks whether the Claude Code client is properly configured with UniBridge MCP server.
        ...
        bool AddMcpServerToConfig(string configPath, string mainFile)
        {
            ...
            var args = new JArray { "--mcp", "--project-id", ProjectIdentity.GetOrCreate().ProjectId };
