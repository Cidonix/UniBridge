...
namespace Cidonix.UniBridge.MCP.Editor.Settings
{
    ...
    class MCPSettings
    {
        ...
        public bool autoApproveInEditorMode = false;
        ...
        void EnsureToolOverrideLists()
        {
            enabledToolOverrides ??= new List<string>();
            disabledToolOverrides ??= new List<string>();
        }
