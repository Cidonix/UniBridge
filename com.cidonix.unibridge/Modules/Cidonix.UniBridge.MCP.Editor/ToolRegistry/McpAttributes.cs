...
namespace Cidonix.UniBridge.MCP.Editor.ToolRegistry
{
    ...
    public class McpToolAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets or sets the execution policy used by the UniBridge scheduler.
        /// Leave as Auto to let the scheduler infer read-only, mutating, capture, or lifecycle behavior.
        /// </summary>
