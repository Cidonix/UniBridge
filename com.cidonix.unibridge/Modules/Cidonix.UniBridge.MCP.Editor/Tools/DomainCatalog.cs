        ...
        static DomainDefinition[] GetDomains()
        {
            return new[]
            {
                ...
                new DomainDefinition
                {
                    ...
                    FirstCalls = new[] { "UniBridge_ScriptIntelligence Search", "UniBridge_ScriptIntelligence Usages IncludeUsageLocations=true", "UniBridge_ScriptIntelligence MemberUsages Member=<methodOrField>", "UniBridge_ScriptIntelligence CodeUsages Member=<methodOrField>", "UniBridge_BehaviourContext IncludeSource=true", "UniBridge_GetSha" },
                    ...
                    Aliases = new[] { "scripts", "code", "csharp", "monobehaviour", "script_usages", "code_usages", "caller_scan", "member_callers", "member_usages", "serialized_member_usages" }
                }
            };
        }
