...
namespace Cidonix.UniBridge.MCP.Editor.Tools
{
    ...
    {
        /// <summary>
        /// Description of the UniBridge_ManageShader tool for MCP clients.
        ...
        public const string Description = @"Create, read, update, or delete Unity .shader files under Assets.

Use this for source-level shader files. Use UniBridge_ManageAsset for materials, folders, and asset metadata.

Args:
    Action: Create, Read, Update, or Delete.
    Name: Shader file name without the .shader extension.
    Path: Folder under Assets/ (default: Assets/Shaders).
    Contents: ShaderLab/HLSL source for Create or Update.
    EncodedContents: Base64 shader source when ContentsEncoded is true.

Returns:
    success, message, and optional data with shader name, path, and source contents for Read.";
        /// <summary>
        /// Returns the output schema for this tool.
        /// </summary>
        /// <returns>The JSON schema object describing the tool's output structure.</returns>
        [McpOutputSchema("UniBridge_ManageShader")]
        ...
        [McpTool("UniBridge_ManageShader", Description, Title, Groups = new string[] { "assets", "scripting" }, EnabledByDefault = true)]
