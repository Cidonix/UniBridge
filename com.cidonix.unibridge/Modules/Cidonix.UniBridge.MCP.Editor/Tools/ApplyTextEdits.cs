...
namespace Cidonix.UniBridge.MCP.Editor.Tools
{
    ...
    {
        /// <summary>
        /// Human-readable description of the UniBridge_ApplyTextEdits tool functionality and usage guidelines.
        /// </summary>
        public const string Title = "Apply text edits to a file";

        public const string Description = @"Apply precise line/column text edits to a C# script.

Use this for small, exact replacements after reading the target lines. Prefer UniBridge_ScriptApplyEdits for method/class edits or anchor-based changes.

Important:
    Coordinates are 1-based. Tabs count as one column. Always verify the target text with UniBridge_ReadResource or UniBridge_FindInFile before editing.

Args:
    uri: unity://path/..., file://..., or Assets/... path to a .cs file.
    edits: List of {startLine,startCol,endLine,endCol,newText}.
    precondition_sha256: Optional SHA256 guard from UniBridge_GetSha.
...
Returns:
    success, message, and data with editsApplied, sha256, refresh status, normalized edits, and warnings.";
        ...
        [McpOutputSchema("UniBridge_ApplyTextEdits")]
        ...
        [McpTool("UniBridge_ApplyTextEdits", Description, Title, Groups = new string[] { "core", "scripting" }, EnabledByDefault = true)]
        public static object HandleCommand(ApplyTextEditsParams parameters)
        {
            ...
            try
            {
                ...
                // Create parameters for the script router command.
