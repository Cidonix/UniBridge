...
{
    /// <summary>
    /// Asset actions that can be performed by the UniBridge_ManageAsset tool.
    /// </summary>
    public enum AssetAction
    {
        ...
        /// <summary>
        /// Create a new asset or update an existing asset when the type matches.
        /// </summary>
        CreateOrUpdate,
    ...
    /// <summary>
    /// Demonstrates typed parameter record for UniBridge_ManageAsset tool.
    ...
    public record ManageAssetParams
    {
        ...
        /// </summary>
        [McpDescription("Operation to perform (e.g., 'Import', 'Create', 'CreateOrUpdate', 'Modify', 'Delete', 'Duplicate', 'Move', 'Rename', 'Search', 'GetInfo', 'CreateFolder', 'GetComponents').", Required = true)]
