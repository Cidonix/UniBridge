...
namespace Cidonix.UniBridge.MCP.Editor.Tools.Parameters
{
    ...
    public record EditorStateData
    {
        ...
        /// <summary>
        /// Gets or sets whether the editor is in play mode or about to change play mode.
        /// </summary>
        [McpDescription("Whether the editor is in play mode or about to change play mode")]
        ...
        /// <summary>
        /// Gets or sets whether the editor currently satisfies the default ready checks.
        /// </summary>
        [McpDescription("Whether the editor is ready for the next agent action")]
    ...
    public record SelectionObjectInfo
    {
        ...
        /// <summary>
        /// Gets or sets whether the selected object is a project asset.
        /// </summary>
        [McpDescription("Whether the selected object is a project asset")]
        public bool IsPersistent { get; set; }

        /// <summary>
        /// Gets or sets the project asset path or scene hierarchy path.
        /// </summary>
        [McpDescription("Project asset path or scene hierarchy path")]
        public string Path { get; set; }

        /// <summary>
        /// Gets or sets the project asset GUID when available.
        /// </summary>
        [McpDescription("Project asset GUID when available")]
        public string Guid { get; set; }

        /// <summary>
        /// Gets or sets the scene asset path when the object is a scene object.
        /// </summary>
        [McpDescription("Scene path when the object is a scene object")]
    ...
    public record GameObjectSelectionInfo
    {
        ...
        /// <summary>
        /// Gets or sets the GameObject hierarchy path.
        /// </summary>
        [McpDescription("GameObject hierarchy path")]
        public string Path { get; set; }

        /// <summary>
        /// Gets or sets the scene asset path.
        /// </summary>
        [McpDescription("Scene asset path")]
        public string ScenePath { get; set; }

        /// <summary>
        /// Gets or sets whether the GameObject is active in hierarchy.
        /// </summary>
        [McpDescription("Whether the GameObject is active in hierarchy")]
