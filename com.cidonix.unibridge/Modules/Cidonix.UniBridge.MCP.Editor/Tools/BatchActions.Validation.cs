        ...
        static ValidationReport ValidateStep(BatchStep step, Dictionary<string, ToolSettingsEntry> toolSettings)
        {
            ...
            switch (step.ToolName)
            {
                ...
                case "UniBridge_RuntimeProfiler":
                    report.Info("Runtime profiler is read-only and uses bounded sampling. Action=Sample and Action=Hierarchy require Play Mode unless RequirePlayMode=false is passed.");
                    break;
