        ...
        static WorkflowGuide[] GetWorkflows()
        {
            return new[]
            {
                ...
                new WorkflowGuide
                {
                    ...
                    FirstCalls = new[] { "UniBridge_UnitySearch with Sources suited to the task", "UniBridge_AssetIntelligence Search/Context/ResolveMissing for asset-heavy tasks", "UniBridge_AssetIntelligence Action=Structure StructureMode=Search for prefab or loaded scene hierarchy/serialized-field lookup", "UniBridge_AssetIntelligence ReferenceGraph/Impact IncludeReferenceLocations=true when exact YAML reference sites matter", "UniBridge_ScriptIntelligence Search/Usages/MemberUsages for code/type/member tasks", "UniBridge_TypeSchema Action=TypeIndex for loaded Unity/C# type lookup" },
                    EditCalls = Array.Empty<string>(),
                ...
                new WorkflowGuide
                {
                    ...
                    BatchAliases = new[] { "asset_ref_search", "asset_reference_search", "asset_usages", "reference_graph", "reference_locations", "script_usages", "asset_script_usages", "guid_usages", "member_usages", "serialized_member_usages", "unity_event_usages", "animation_event_usages", "serialized_field_usages" },
                    Notes = new[] { "Reference locations are read-only and bounded. They include assetPath, line, column, propertyPath, YAML document type/fileId, and prefab/scene object path when inferable.", "For script assets, ScriptIntelligence Usages resolves prefab/scene YAML references to the script GUID with line/property/object context.", "Use ScriptIntelligence MemberUsages before renaming UnityEvent handlers, AnimationEvent functions, or serialized fields; exact matches are proven by script GUID, possible/runtime matches are marked for verification.", "Use the returned indexedObjectPath when sibling names are duplicated." },
                    Aliases = new[] { "asset_ref_search", "asset_reference_search", "reference_locations", "script_usages", "asset_script_usages", "guid_usages", "member_usages", "serialized_member_usages" }
                },
                new WorkflowGuide
                {
                    Key = "asset_structure",
