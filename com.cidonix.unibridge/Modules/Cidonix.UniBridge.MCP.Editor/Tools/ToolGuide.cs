        ...
        static WorkflowGuide[] GetWorkflows()
        {
            return new[]
            {
                ...
                new WorkflowGuide
                {
                    ...
                    FirstCalls = new[] { "UniBridge_UnitySearch with Sources suited to the task", "UniBridge_AssetIntelligence Search/Context/ResolveMissing for asset-heavy tasks", "UniBridge_AssetIntelligence Action=Structure StructureMode=Search for prefab or loaded scene hierarchy/serialized-field lookup", "UniBridge_AssetIntelligence ReferenceGraph/Impact IncludeReferenceLocations=true when exact YAML reference sites matter", "UniBridge_ScriptIntelligence Search/Usages/MemberUsages/CodeUsages for code/type/member tasks", "UniBridge_TypeSchema Action=TypeIndex for loaded Unity/C# type lookup" },
                    EditCalls = Array.Empty<string>(),
                ...
                new WorkflowGuide
                {
                    ...
                    FirstCalls = new[] { "UniBridge_ScriptIntelligence Search/Inspect", "UniBridge_ScriptIntelligence Usages IncludeUsageLocations=true when prefab/scene references matter", "UniBridge_ScriptIntelligence MemberUsages Member=<methodOrField> before renaming serialized callbacks/fields", "UniBridge_ScriptIntelligence CodeUsages Member=<methodOrField> before renaming/removing C# API used by other scripts", "UniBridge_GetSha before direct text edits" },
                    ...
                    BatchAliases = new[] { "script_intelligence", "script_search", "script_usages", "asset_script_usages", "code_usages", "caller_scan", "member_callers", "code_member_usages", "member_usages", "serialized_member_usages", "unity_event_usages", "animation_event_usages", "serialized_field_usages", "validate_script", "script_validate", "cs_validation" },
                    ...
                    Aliases = new[] { "code", "csharp", "cs", "script", "script_usages", "code_usages", "caller_scan", "member_callers", "serialized_member_usages" }
                },
                new WorkflowGuide
                {
                    Key = "batch",
